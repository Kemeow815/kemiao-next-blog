...
date: '2025-04-14T08:08:39.000Z'
image: /images/waline.webp
tags:
  - Waline
  - 评论系统
  - 部署
draft: false
updatedOn: '2025-04-14T08:47:21.437Z'
---
...
1. 点击左上角 [创建应用](https://console.leancloud.app/apps) 并起一个你喜欢的名字 (请选择免费的开发版):
   ...
   ![创建应用](/images/waline/1.png)

1. 进入应用，选择左下角的 `设置` > `应用 Key`。你可以看到你的 `APP ID`，`APP Key` 和 `Master Key`。请记录它们，以便后续使用。

   ![ID 和 Key](/images/waline/2.png)

---
## 在 Vercel 部署
[![Vercel](/images/waline/vercel.svg)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fwalinejs%2Fwaline%2Ftree%2Fmain%2Fexample)
...
1. 输入一个你喜欢的 Vercel 项目名称并点击 `Create` 继续:
   ...
   ![创建项目](/images/waline/3.png)

1. 此时 Vercel 会基于 Waline 模板帮助你新建并初始化仓库，仓库名为你之前输入的项目名。

   ![deploy](/images/waline/4.png)

   一两分钟后，满屏的烟花会庆祝你部署成功。此时点击 `Go to Dashboard` 可以跳转到应用的控制台。

   ![deploy](/images/waline/5.png)
...
1. 输入需要绑定的域名并点击 `Add`
   ...
   ![Add domain](/images/waline/9.png)
...
<Bilibili aid="603711299" bvid="BV1pB4y1E7fp" cid="851182849" />

### 使用 Vercel 简单地部署 Waline 评论系统

> UP 主：[岚天呀](https://space.bilibili.com/355877984)

<Bilibili aid="986143204" bvid="BV1Ft4y1A73f" cid="851363812" />
